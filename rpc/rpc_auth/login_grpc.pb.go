...
const (
	LoginService_LoginSimpleRPC_FullMethodName        = "/rpc_auth.LoginService/LoginSimpleRPC"
	LoginService_LoginServerStreamRPC_FullMethodName  = "/rpc_auth.LoginService/LoginServerStreamRPC"
	LoginService_LoginClientStreamRPC_FullMethodName  = "/rpc_auth.LoginService/LoginClientStreamRPC"
	LoginService_LoginBiDirectionalRPC_FullMethodName = "/rpc_auth.LoginService/LoginBiDirectionalRPC"
)
...
func (c *loginServiceClient) LoginSimpleRPC(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, LoginService_LoginSimpleRPC_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loginServiceClient) LoginServerStreamRPC(ctx context.Context, in *LoginRequestList, opts ...grpc.CallOption) (LoginService_LoginServerStreamRPCClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LoginService_ServiceDesc.Streams[0], LoginService_LoginServerStreamRPC_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &loginServiceLoginServerStreamRPCClient{ClientStream: stream}
...
func (c *loginServiceClient) LoginClientStreamRPC(ctx context.Context, opts ...grpc.CallOption) (LoginService_LoginClientStreamRPCClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LoginService_ServiceDesc.Streams[1], LoginService_LoginClientStreamRPC_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &loginServiceLoginClientStreamRPCClient{ClientStream: stream}
	return x, nil
}
...
func (c *loginServiceClient) LoginBiDirectionalRPC(ctx context.Context, opts ...grpc.CallOption) (LoginService_LoginBiDirectionalRPCClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LoginService_ServiceDesc.Streams[2], LoginService_LoginBiDirectionalRPC_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &loginServiceLoginBiDirectionalRPCClient{ClientStream: stream}
	return x, nil
}
...
func _LoginService_LoginSimpleRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LoginService_LoginSimpleRPC_FullMethodName,
	}
...
func _LoginService_LoginServerStreamRPC_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LoginServiceServer).LoginServerStreamRPC(m, &loginServiceLoginServerStreamRPCServer{ServerStream: stream})
}
...
func _LoginService_LoginClientStreamRPC_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LoginServiceServer).LoginClientStreamRPC(&loginServiceLoginClientStreamRPCServer{ServerStream: stream})
}
...
func _LoginService_LoginBiDirectionalRPC_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LoginServiceServer).LoginBiDirectionalRPC(&loginServiceLoginBiDirectionalRPCServer{ServerStream: stream})
}
